...
class SVM:
    ...
    def training(self,x,y,x_control,loss_function,C,max_iter,lamb,epochs=500,lr=1, apply_fairness_constraints = 0, sensitive_attrs = ['race'], sensitive_attrs_to_cov_thresh = {},gamma=None):
        '''
